<?php
/** @var array $publications @var ?string $activeType @var int $page @var int $totalPages */
...
<div class="container" style="padding:40px 0">
  ...
  <?php else: ?>
    ...
    <?php if ($totalPages > 1): ?>
    <?php $qs = fn($p) => '/publications?' . http_build_query(array_filter(['type' => $activeType, 'page' => $p])); ?>
